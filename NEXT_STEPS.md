...
2. Verify Supabase persistence end to end with working `projects`, `usage_events`, and `user_profiles` tables so quota tracking and analytics are truly persistent.
